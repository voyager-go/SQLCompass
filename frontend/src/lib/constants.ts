...
export type WorkbenchPage = "connections" | "query" | "history" | "schema" | "create-table" | "partition" | "transfer" | "performance" | "access-control" | "import" | "task-center" | "ai" | "theme" | "settings";
...
export const WORKBENCH_PAGES: PageEntry[] = [
    ...
    { id: "task-center", label: "任务中心", summary: "导入导出任务追踪" },
